...
class Encoder(nn.Module):
    def __init__(self, in_channels: int, width_mult: float = 1.0):
        super().__init__()
...
class WorldModel(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.encoder = Encoder(in_channels=self.n_past_frames, width_mult=width_mult)
    ...
    def forward(
        ...
        z = self.encoder(obs_stack)  # (B, 512, 6, 6)
